...
the top recent model. The sidebar panels (Model, Telemetry) are collapsible for
a cleaner view. Shell outputs that look like unified diffs, git patches, JSON,
YAML, CSV or TSV are rendered with richer formatting; diffs also include a
